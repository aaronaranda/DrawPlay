...
public class Cat {
	...
	private static final int NOSE_HEIGHT = 5;
	private static final int NOSE_WIDTH = HEAD_DIMENSION/12;
	// nose starts about 40% from left edge of head
	private static final int NOSE_X = HEAD_DIMENSION/5 * 2 + 2;
	private static final int NOSE_Y = HEAD_DIMENSION/5 * 2 + 8;
